...
public class EventInvitedFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup parent, Bundle savedInstanceState) {
        View view=inflater.inflate(R.layout.event_invited_view, parent, false);
        eventView=(RecyclerView) view.findViewById(R.id.eventInvitedViewList);
    ...
    public void onStart(){
        ...
        eventAdapter=new FirebaseRecyclerAdapter<Event,EventInvitedHolder>(myEvents) {
            @Override
            public void onBindViewHolder(EventInvitedHolder holder, final int position, final Event event) {
                holder.txtName.setText(event.name);
                holder.txtAddress.setText("At "+event.address+"\n invited by "+event.owner);
            ...
            @Override
            public EventInvitedHolder onCreateViewHolder(final ViewGroup parent, int viewType) {
                View view = LayoutInflater.from(parent.getContext())
                        .inflate(R.layout.event_item, parent, false);
                return new EventInvitedHolder(view);
            }
            @Override
    ...
    private class EventInvitedHolder extends RecyclerView.ViewHolder {
        ...
        public EventInvitedHolder(View itemView) {
            super(itemView);
